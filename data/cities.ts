...
export const cities: City[] = [
  // ===========================================================================
  {
    ...
    services: ["nettoyage-hotte-restaurant", "ramonage-hotte-restaurant", "degraissage-hotte-restaurant", "nettoyage-conduit-extraction"],
    faq: [
      {
  ...
  // ===========================================================================
  {
    ...
    services: ["nettoyage-hotte-restaurant", "ramonage-hotte-restaurant", "degraissage-hotte-restaurant"],
    faq: [
      {
  ...
  // ===========================================================================
  {
    ...
    services: ["nettoyage-hotte-restaurant", "ramonage-hotte-restaurant"],
    faq: [
      {
